...
export class SelectionSettingComponent implements OnInit {
  data: TableData[] = [];
  loading = false;
  total = 0;
  pageIndex = 1;
  ...
  loadData(): void {
    ...
    setTimeout(() => {
      this.data = [
        { id: '1', name: '设置项1', status: '启用', created: new Date() },
        { id: '2', name: '设置项2', status: '禁用', created: new Date() }
      ];
      this.total = 2;
      this.loading = false;
    }, 500);
