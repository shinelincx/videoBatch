...
class NzCheckListButtonComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListButtonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: NzCheckListButtonComponent, isStandalone: true, selector: "nz-check-list-button", host: { classAttribute: "ant-btn ant-btn-primary ant-check-list-button" }, ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListButtonComponent, decorators: [{
            type: Component,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListContentComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], propDecorators: { locale: [{ type: i0.Input, args: [{ isSignal: true, alias: "locale", required: true }] }], items: [{ type: i0.Input, args: [{ isSignal: true, alias: "items", required: false }] }], index: [{ type: i0.Input, args: [{ isSignal: true, alias: "index", required: false }] }], progress: [{ type: i0.Input, args: [{ isSignal: true, alias: "progress", required: false }] }], title: [{ type: i0.Input, args: [{ isSignal: true, alias: "title", required: false }] }], footer: [{ type: i0.Input, args: [{ isSignal: true, alias: "footer", required: false }] }], closePopover: [{ type: i0.Output, args: ["closePopover"] }], hide: [{ type: i0.Output, args: ["hide"] }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], propDecorators: { nzItems: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzItems", required: false }] }], nzVisible: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzVisible", required: false }] }], nzIndex: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzIndex", required: false }] }], nzProgress: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzProgress", required: false }] }], nzTriggerRender: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzTriggerRender", required: false }] }], nzTitle: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzTitle", required: false }] }], nzFooter: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzFooter", required: false }] }], nzHide: [{ type: i0.Output, args: ["nzHide"] }] } });
...
class NzCheckListModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListModule, imports: [NzCheckListComponent], exports: [NzCheckListComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListModule, imports: [NzCheckListComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckListModule, decorators: [{
            type: NgModule,
            args: [{
