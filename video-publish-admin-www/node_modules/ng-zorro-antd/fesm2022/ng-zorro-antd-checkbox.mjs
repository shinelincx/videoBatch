...
import { InjectionToken, inject, NgZone, ElementRef, ChangeDetectorRef, DestroyRef, EventEmitter, effect, forwardRef, booleanAttribute, Input, Output, ViewChild, ViewEncapsulation, ChangeDetectionStrategy, Component, input, signal, linkedSignal, computed, afterNextRender, untracked, NgModule } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxComponent, decorators: [{
            type: Component,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxGroupComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [], propDecorators: { nzName: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzName", required: false }] }], nzDisabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzDisabled", required: false }] }], nzOptions: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOptions", required: false }] }] } });
...
class NzCheckboxModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxModule, imports: [NzCheckboxComponent, NzCheckboxGroupComponent], exports: [NzCheckboxComponent, NzCheckboxGroupComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxModule, imports: [NzCheckboxComponent, NzCheckboxGroupComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzCheckboxModule, decorators: [{
            type: NgModule,
            args: [{
...
export { NZ_CHECKBOX_GROUP, NzCheckboxComponent, NzCheckboxGroupComponent, NzCheckboxModule };
