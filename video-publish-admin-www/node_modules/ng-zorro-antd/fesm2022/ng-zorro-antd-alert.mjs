...
import { inject, DestroyRef, input, booleanAttribute, numberAttribute, viewChild, signal, computed, afterNextRender, ViewEncapsulation, ChangeDetectionStrategy, Component, ChangeDetectorRef, ANIMATION_MODULE_TYPE, EventEmitter, Output, Input, NgModule } from '@angular/core';
 ...
 */
class NzAlertMarqueeComponent {
    destroyRef = inject(DestroyRef);
    nzPauseOnHover = input(false, { ...(ngDevMode ? { debugName: "nzPauseOnHover" } : {}), transform: booleanAttribute });
    nzSpeed = input(50, { ...(ngDevMode ? { debugName: "nzSpeed" } : {}), transform: numberAttribute });
    track1Ref = viewChild.required('track1');
    track2Ref = viewChild.required('track2');
    trackWidth = signal(0, ...(ngDevMode ? [{ debugName: "trackWidth" }] : []));
    animationDuration = computed(() => {
        const width = this.trackWidth();
        const speed = this.nzSpeed();
        return width > 0 && speed > 0 ? width / speed : 20;
    }, ...(ngDevMode ? [{ debugName: "animationDuration" }] : []));
    class = computed(() => ({
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertMarqueeComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.2.0", version: "21.2.0", type: NzAlertMarqueeComponent, isStandalone: true, selector: "nz-alert-marquee", inputs: { nzPauseOnHover: { classPropertyName: "nzPauseOnHover", publicName: "nzPauseOnHover", isSignal: true, isRequired: false, transformFunction: null }, nzSpeed: { classPropertyName: "nzSpeed", publicName: "nzSpeed", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "class()" } }, viewQueries: [{ propertyName: "track1Ref", first: true, predicate: ["track1"], descendants: true, isSignal: true }, { propertyName: "track2Ref", first: true, predicate: ["track2"], descendants: true, isSignal: true }], ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertMarqueeComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [], propDecorators: { nzPauseOnHover: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzPauseOnHover", required: false }] }], nzSpeed: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzSpeed", required: false }] }], track1Ref: [{ type: i0.ViewChild, args: ['track1', { isSignal: true }] }], track2Ref: [{ type: i0.ViewChild, args: ['track2', { isSignal: true }] }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'nz-alert',
                    exportAs: 'nzAlert',
 ...
 */
class NzAlertModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzAlertModule, imports: [NzAlertComponent, NzAlertMarqueeComponent], exports: [NzAlertComponent, NzAlertMarqueeComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertModule, imports: [NzAlertComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzAlertModule, decorators: [{
            type: NgModule,
            args: [{
...
export { NzAlertComponent, NzAlertMarqueeComponent, NzAlertModule };
