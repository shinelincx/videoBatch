...
import { NZ_FORM_SIZE, NZ_FORM_VARIANT, NzFormStatusService } from 'ng-zorro-antd/core/form';
...
class NzFormItemComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormItemComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: NzFormItemComponent, isStandalone: true, selector: "nz-form-item", host: { properties: { "class.ant-form-item-has-success": "status === \"success\"", "class.ant-form-item-has-warning": "status === \"warning\"", "class.ant-form-item-has-error": "status === \"error\"", "class.ant-form-item-is-validating": "status === \"validating\"", "class.ant-form-item-has-feedback": "hasFeedback && status", "class.ant-form-item-with-help": "withHelpClass" }, classAttribute: "ant-form-item" }, exportAs: ["nzFormItem"], ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormItemComponent, decorators: [{
            type: Component,
            args: [{
...
let NzFormDirective = (() => {
    ...
    return class NzFormDirective {
        ...
        nzSize = (__runInitializers(this, _nzLabelWrap_extraInitializers), input(...(ngDevMode ? [undefined, { debugName: "nzSize" }] : [])));
        nzVariant = input('outlined', ...(ngDevMode ? [{ debugName: "nzVariant" }] : []));
        nzRequiredMark = input(true, ...(ngDevMode ? [{ debugName: "nzRequiredMark" }] : []));
        ...
        static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
        static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.2.0", type: NzFormDirective, isStandalone: true, selector: "[nz-form]", inputs: { nzLayout: { classPropertyName: "nzLayout", publicName: "nzLayout", isSignal: false, isRequired: false, transformFunction: null }, nzNoColon: { classPropertyName: "nzNoColon", publicName: "nzNoColon", isSignal: false, isRequired: false, transformFunction: booleanAttribute }, nzAutoTips: { classPropertyName: "nzAutoTips", publicName: "nzAutoTips", isSignal: false, isRequired: false, transformFunction: null }, nzDisableAutoTips: { classPropertyName: "nzDisableAutoTips", publicName: "nzDisableAutoTips", isSignal: false, isRequired: false, transformFunction: booleanAttribute }, nzTooltipIcon: { classPropertyName: "nzTooltipIcon", publicName: "nzTooltipIcon", isSignal: false, isRequired: false, transformFunction: null }, nzLabelAlign: { classPropertyName: "nzLabelAlign", publicName: "nzLabelAlign", isSignal: false, isRequired: false, transformFunction: null }, nzLabelWrap: { classPropertyName: "nzLabelWrap", publicName: "nzLabelWrap", isSignal: false, isRequired: false, transformFunction: booleanAttribute }, nzSize: { classPropertyName: "nzSize", publicName: "nzSize", isSignal: true, isRequired: false, transformFunction: null }, nzVariant: { classPropertyName: "nzVariant", publicName: "nzVariant", isSignal: true, isRequired: false, transformFunction: null }, nzRequiredMark: { classPropertyName: "nzRequiredMark", publicName: "nzRequiredMark", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class.ant-form-horizontal": "nzLayout === 'horizontal'", "class.ant-form-vertical": "nzLayout === 'vertical'", "class.ant-form-inline": "nzLayout === 'inline'", "class.ant-form-rtl": "dir() === 'rtl'", "class.ant-form-small": "nzSize() === 'small'", "class.ant-form-large": "nzSize() === 'large'" }, classAttribute: "ant-form" }, providers: [
            ...
            ], exportAs: ["nzForm"], usesOnChanges: true, ngImport: i0 });
    };
})();
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[nz-form]',
                    exportAs: 'nzForm',
                ...
                type: Input,
                args: [{ transform: booleanAttribute }]
            }], nzSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzSize", required: false }] }], nzVariant: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzVariant", required: false }] }], nzRequiredMark: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzRequiredMark", required: false }] }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormControlComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFormLabelComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormLabelComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.0", type: NzFormLabelComponent, isStandalone: true, selector: "nz-form-label", inputs: { nzFor: "nzFor", nzRequired: ["nzRequired", "nzRequired", booleanAttribute], nzNoColon: ["nzNoColon", "nzNoColon", booleanAttribute], nzTooltipTitle: "nzTooltipTitle", nzTooltipIcon: "nzTooltipIcon", nzLabelAlign: "nzLabelAlign", nzLabelWrap: ["nzLabelWrap", "nzLabelWrap", booleanAttribute] }, host: { properties: { "class.ant-form-item-label-left": "nzLabelAlign === 'left'", "class.ant-form-item-label-wrap": "nzLabelWrap" }, classAttribute: "ant-form-item-label" }, exportAs: ["nzFormLabel"], ngImport: i0, template: `
    <label
      [attr.for]="nzFor"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormLabelComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFormSplitComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormSplitComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: NzFormSplitComponent, isStandalone: true, selector: "nz-form-split", host: { classAttribute: "ant-form-split" }, exportAs: ["nzFormSplit"], ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormSplitComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFormTextComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormTextComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.0", type: NzFormTextComponent, isStandalone: true, selector: "nz-form-text", host: { classAttribute: "ant-form-text" }, exportAs: ["nzFormText"], ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormTextComponent, decorators: [{
            type: Component,
            args: [{
 ...
 */
class NzFormModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzFormModule, imports: [NzFormDirective,
            NzFormItemComponent,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormModule, imports: [NzFormLabelComponent,
            NzFormControlComponent, NzGridModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFormModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        NzFormDirective,
