...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzButtonComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
                ...
                type: Input
            }], iconDir: [{ type: i0.ContentChild, args: [i0.forwardRef(() => NzIconDirective), { isSignal: true }] }], loadingIconDir: [{ type: i0.ViewChild, args: [i0.forwardRef(() => NzIconDirective), { isSignal: true }] }] } });
...
class NzButtonModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzButtonModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzButtonModule, imports: [NzButtonComponent], exports: [NzButtonComponent, _NzTransitionPatchModule, NzWaveModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzButtonModule, imports: [NzButtonComponent, _NzTransitionPatchModule, NzWaveModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzButtonModule, decorators: [{
            type: NgModule,
            args: [{
