...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonContentComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFloatButtonComponent {
    ...
    nzBadge = input(null, ...(ngDevMode ? [{ debugName: "nzBadge" }] : []));
    nzOnClick = output();
    shape = linkedSignal(() => this.nzShape(), ...(ngDevMode ? [{ debugName: "shape" }] : []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFloatButtonTopComponent {
    ...
    backTop = viewChild('backTop', { ...(ngDevMode ? { debugName: "backTop" } : {}), read: ElementRef });
    ...
    nzTarget = input(null, ...(ngDevMode ? [{ debugName: "nzTarget" }] : []));
    nzDuration = input(450, { ...(ngDevMode ? { debugName: "nzDuration" } : {}), transform: numberAttribute });
    nzBadge = input(null, ...(ngDevMode ? [{ debugName: "nzBadge" }] : []));
    nzOnClick = output();
  ...
  `, isInline: true, dependencies: [{ kind: "component", type: NzFloatButtonComponent, selector: "nz-float-button", inputs: ["nzHref", "nzTarget", "nzType", "nzIcon", "nzDescription", "nzShape", "nzBadge"], outputs: ["nzOnClick"], exportAs: ["nzFloatButton"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonTopComponent, decorators: [{
            type: Component,
            args: [{
...
class NzFloatButtonGroupComponent {
    ...
    dir = inject(Directionality).valueSignal;
    open = linkedSignal(() => !!this.nzOpen(), ...(ngDevMode ? [{ debugName: "open" }] : []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonGroupComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.0", type: NzFloatButtonGroupComponent, isStandalone: true, selector: "nz-float-button-group", inputs: { nzHref: { classPropertyName: "nzHref", publicName: "nzHref", isSignal: true, isRequired: false, transformFunction: null }, nzTarget: { classPropertyName: "nzTarget", publicName: "nzTarget", isSignal: true, isRequired: false, transformFunction: null }, nzType: { classPropertyName: "nzType", publicName: "nzType", isSignal: true, isRequired: false, transformFunction: null }, nzIcon: { classPropertyName: "nzIcon", publicName: "nzIcon", isSignal: true, isRequired: false, transformFunction: null }, nzDescription: { classPropertyName: "nzDescription", publicName: "nzDescription", isSignal: true, isRequired: false, transformFunction: null }, nzShape: { classPropertyName: "nzShape", publicName: "nzShape", isSignal: true, isRequired: false, transformFunction: null }, nzTrigger: { classPropertyName: "nzTrigger", publicName: "nzTrigger", isSignal: true, isRequired: false, transformFunction: null }, nzOpen: { classPropertyName: "nzOpen", publicName: "nzOpen", isSignal: true, isRequired: false, transformFunction: null }, nzPlacement: { classPropertyName: "nzPlacement", publicName: "nzPlacement", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { nzOnOpenChange: "nzOnOpenChange" }, host: { listeners: { "mouseleave": "hoverCloseMenu()" }, properties: { "class": "class()" } }, queries: [{ propertyName: "nzFloatButtonComponents", predicate: NzFloatButtonComponent, isSignal: true }, { propertyName: "nzFloatButtonTopComponents", predicate: NzFloatButtonTopComponent, isSignal: true }], exportAs: ["nzFloatButtonGroup"], ngImport: i0, template: `
    @if (!isMenuMode()) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonGroupComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [], propDecorators: { nzFloatButtonComponents: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => NzFloatButtonComponent), { isSignal: true }] }], nzFloatButtonTopComponents: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => NzFloatButtonTopComponent), { isSignal: true }] }], nzHref: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzHref", required: false }] }], nzTarget: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzTarget", required: false }] }], nzType: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzType", required: false }] }], nzIcon: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzIcon", required: false }] }], nzDescription: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzDescription", required: false }] }], nzShape: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzShape", required: false }] }], nzTrigger: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzTrigger", required: false }] }], nzOpen: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOpen", required: false }] }], nzPlacement: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzPlacement", required: false }] }], nzOnOpenChange: [{ type: i0.Output, args: ["nzOnOpenChange"] }] } });
...
class NzFloatButtonModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonModule, imports: [NzFloatButtonComponent,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonModule, imports: [NzFloatButtonComponent,
            NzFloatButtonGroupComponent,
            NzFloatButtonTopComponent,
            NzFloatButtonContentComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzFloatButtonModule, decorators: [{
            type: NgModule,
            args: [{
                    exports: [
