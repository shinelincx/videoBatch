...
class NzWatermarkComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "16.1.0", version: "21.2.0", type: NzWatermarkComponent, isStandalone: true, selector: "nz-watermark", inputs: { nzWidth: ["nzWidth", "nzWidth", numberAttribute], nzHeight: ["nzHeight", "nzHeight", numberAttribute], nzRotate: ["nzRotate", "nzRotate", numberAttribute], nzZIndex: ["nzZIndex", "nzZIndex", numberAttribute], nzImage: "nzImage", nzContent: "nzContent", nzFont: "nzFont", nzGap: "nzGap", nzOffset: "nzOffset" }, exportAs: ["nzWatermark"], usesOnChanges: true, ngImport: i0, template: `<ng-content />`, isInline: true, styles: [":host{position:relative;display:block;overflow:hidden}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkComponent, decorators: [{
            type: Component,
            args: [{ selector: 'nz-watermark', exportAs: 'nzWatermark', changeDetection: ChangeDetectionStrategy.OnPush, template: `<ng-content />`, styles: [":host{position:relative;display:block;overflow:hidden}\n"] }]
...
class NzWatermarkModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkModule, imports: [NzWatermarkComponent], exports: [NzWatermarkComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkModule });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzWatermarkModule, decorators: [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=ng-zorro-antd-watermark.mjs.map
