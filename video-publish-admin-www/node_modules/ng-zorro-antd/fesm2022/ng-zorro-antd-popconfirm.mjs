...
let NzPopconfirmDirective = (() => {
    ...
    return class NzPopconfirmDirective extends _classSuper {
         ...
         */
        nzOkDisabled = input(false, { ...(ngDevMode ? { debugName: "nzOkDisabled" } : {}), transform: booleanAttribute });
        /**
         * @deprecated v21
         * please use the nzOkButton object input to describe option of the ok button
         */
        nzOkDanger = input(false, { ...(ngDevMode ? { debugName: "nzOkDanger" } : {}), transform: booleanAttribute });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmDirective, decorators: [{
            ...
            args: [{
                ...
                type: Input
            }], nzOkText: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOkText", required: false }] }], nzOkType: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOkType", required: false }] }], nzCancelText: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzCancelText", required: false }] }], nzOkButtonProps: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOkButtonProps", required: false }] }], nzCancelButtonProps: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzCancelButtonProps", required: false }] }], nzOkDisabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOkDisabled", required: false }] }], nzOkDanger: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzOkDanger", required: false }] }], visibleChange: [{
                type: Output,
...
class NzPopconfirmComponent extends NzTooltipComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.0", type: NzPopconfirmComponent, isStandalone: true, selector: "nz-popconfirm", viewQueries: [{ propertyName: "okBtn", predicate: ["okBtn"], descendants: true, read: ElementRef }, { propertyName: "cancelBtn", predicate: ["cancelBtn"], descendants: true, read: ElementRef }], exportAs: ["nzPopconfirmComponent"], usesInheritance: true, ngImport: i0, template: `
    <ng-template
...
class NzPopconfirmModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmModule, imports: [NzPopconfirmComponent, NzPopconfirmDirective], exports: [NzPopconfirmComponent, NzPopconfirmDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmModule, imports: [NzPopconfirmComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzPopconfirmModule, decorators: [{
            type: NgModule,
            args: [{
