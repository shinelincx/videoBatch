...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterBarComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], propDecorators: { ariaNow: [{ type: i0.Input, args: [{ isSignal: true, alias: "ariaNow", required: true }] }], ariaMin: [{ type: i0.Input, args: [{ isSignal: true, alias: "ariaMin", required: true }] }], ariaMax: [{ type: i0.Input, args: [{ isSignal: true, alias: "ariaMax", required: true }] }], active: [{ type: i0.Input, args: [{ isSignal: true, alias: "active", required: false }] }], resizable: [{ type: i0.Input, args: [{ isSignal: true, alias: "resizable", required: false }] }], vertical: [{ type: i0.Input, args: [{ isSignal: true, alias: "vertical", required: false }] }], lazy: [{ type: i0.Input, args: [{ isSignal: true, alias: "lazy", required: false }] }], collapsible: [{ type: i0.Input, args: [{ isSignal: true, alias: "collapsible", required: false }] }], constrainedOffset: [{ type: i0.Input, args: [{ isSignal: true, alias: "constrainedOffset", required: false }] }], offsetStart: [{ type: i0.Output, args: ["offsetStart"] }], collapse: [{ type: i0.Output, args: ["collapse"] }] } });
...
class NzSplitterPanelComponent {
    ...
    nzResizable = input(true, { ...(ngDevMode ? { debugName: "nzResizable" } : {}), transform: booleanAttribute });
    contentTemplate = viewChild.required('contentTemplate');
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterPanelComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.2.0", version: "21.2.0", type: NzSplitterPanelComponent, isStandalone: true, selector: "nz-splitter-panel", inputs: { nzDefaultSize: { classPropertyName: "nzDefaultSize", publicName: "nzDefaultSize", isSignal: true, isRequired: false, transformFunction: null }, nzMin: { classPropertyName: "nzMin", publicName: "nzMin", isSignal: true, isRequired: false, transformFunction: null }, nzMax: { classPropertyName: "nzMax", publicName: "nzMax", isSignal: true, isRequired: false, transformFunction: null }, nzSize: { classPropertyName: "nzSize", publicName: "nzSize", isSignal: true, isRequired: false, transformFunction: null }, nzCollapsible: { classPropertyName: "nzCollapsible", publicName: "nzCollapsible", isSignal: true, isRequired: false, transformFunction: null }, nzResizable: { classPropertyName: "nzResizable", publicName: "nzResizable", isSignal: true, isRequired: false, transformFunction: null } }, viewQueries: [{ propertyName: "contentTemplate", first: true, predicate: ["contentTemplate"], descendants: true, isSignal: true }], exportAs: ["nzSplitterPanel"], ngImport: i0, template: `
    <ng-template #contentTemplate>
      <ng-content />
    </ng-template>
  `, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterPanelComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], propDecorators: { nzDefaultSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzDefaultSize", required: false }] }], nzMin: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzMin", required: false }] }], nzMax: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzMax", required: false }] }], nzSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzSize", required: false }] }], nzCollapsible: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzCollapsible", required: false }] }], nzResizable: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzResizable", required: false }] }], contentTemplate: [{ type: i0.ViewChild, args: ['contentTemplate', { isSignal: true }] }] } });
...
class NzSplitterComponent {
    ...
    nzLazy = input(false, { ...(ngDevMode ? { debugName: "nzLazy" } : {}), transform: booleanAttribute });
     ...
     */
    innerSizes = linkedSignal({ ...(ngDevMode ? { debugName: "innerSizes" } : {}), source: this.panelProps,
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.0", type: NzSplitterComponent, isStandalone: true, selector: "nz-splitter", inputs: { nzLayout: { classPropertyName: "nzLayout", publicName: "nzLayout", isSignal: true, isRequired: false, transformFunction: null }, nzLazy: { classPropertyName: "nzLazy", publicName: "nzLazy", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { nzResizeStart: "nzResizeStart", nzResize: "nzResize", nzResizeEnd: "nzResizeEnd" }, host: { properties: { "class.ant-splitter-horizontal": "nzLayout() === \"horizontal\"", "class.ant-splitter-vertical": "nzLayout() === \"vertical\"", "class.ant-splitter-rtl": "dir() === \"rtl\"" }, classAttribute: "ant-splitter" }, providers: [NzDestroyService], queries: [{ propertyName: "panels", predicate: NzSplitterPanelComponent, isSignal: true }], exportAs: ["nzSplitter"], ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], propDecorators: { nzLayout: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzLayout", required: false }] }], nzLazy: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzLazy", required: false }] }], nzResizeStart: [{ type: i0.Output, args: ["nzResizeStart"] }], nzResize: [{ type: i0.Output, args: ["nzResize"] }], nzResizeEnd: [{ type: i0.Output, args: ["nzResizeEnd"] }], panels: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => NzSplitterPanelComponent), { isSignal: true }] }] } });
...
class NzSplitterModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterModule, imports: [NzSplitterComponent, NzSplitterPanelComponent], exports: [NzSplitterComponent, NzSplitterPanelComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterModule, imports: [NzSplitterComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzSplitterModule, decorators: [{
            type: NgModule,
            args: [{
