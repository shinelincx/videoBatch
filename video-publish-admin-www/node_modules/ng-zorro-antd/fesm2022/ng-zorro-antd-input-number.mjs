...
import { isNotNil, getStatusClassNames, getVariantClassNames, isNil, triggerFocus } from 'ng-zorro-antd/core/util';
...
class NzInputNumberComponent {
    ...
    nzStep = input(1, { ...(ngDevMode ? { debugName: "nzStep" } : {}), transform: numberAttribute });
    nzMin = input(Number.MIN_SAFE_INTEGER, { ...(ngDevMode ? { debugName: "nzMin" } : {}), transform: numberAttribute });
    nzMax = input(Number.MAX_SAFE_INTEGER, { ...(ngDevMode ? { debugName: "nzMax" } : {}), transform: numberAttribute });
    ...
    nzReadOnly = input(false, { ...(ngDevMode ? { debugName: "nzReadOnly" } : {}), transform: booleanAttribute });
    nzAutoFocus = input(false, { ...(ngDevMode ? { debugName: "nzAutoFocus" } : {}), transform: booleanAttribute });
    nzKeyboard = input(true, { ...(ngDevMode ? { debugName: "nzKeyboard" } : {}), transform: booleanAttribute });
    nzControls = input(true, { ...(ngDevMode ? { debugName: "nzControls" } : {}), transform: booleanAttribute });
    nzChangeOnWheel = input(true, { ...(ngDevMode ? { debugName: "nzChangeOnWheel" } : {}), transform: booleanAttribute });
    ...
    finalStatus = linkedSignal(() => this.nzStatus(), ...(ngDevMode ? [{ debugName: "finalStatus" }] : []));
    finalDisabled = linkedSignal(() => this.nzDisabled(), ...(ngDevMode ? [{ debugName: "finalDisabled" }] : []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzInputNumberComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [], propDecorators: { nzId: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzId", required: false }] }], nzSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzSize", required: false }] }], nzPlaceHolder: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzPlaceHolder", required: false }] }], nzStatus: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzStatus", required: false }] }], nzVariant: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzVariant", required: false }] }], nzStep: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzStep", required: false }] }], nzMin: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzMin", required: false }] }], nzMax: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzMax", required: false }] }], nzPrecision: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzPrecision", required: false }] }], nzParser: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzParser", required: false }] }], nzFormatter: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzFormatter", required: false }] }], nzDisabled: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzDisabled", required: false }] }], nzReadOnly: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzReadOnly", required: false }] }], nzAutoFocus: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzAutoFocus", required: false }] }], nzKeyboard: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzKeyboard", required: false }] }], nzControls: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzControls", required: false }] }], nzChangeOnWheel: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzChangeOnWheel", required: false }] }], nzPrefix: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzPrefix", required: false }] }], nzSuffix: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzSuffix", required: false }] }], nzAddonBefore: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzAddonBefore", required: false }] }], nzAddonAfter: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzAddonAfter", required: false }] }], nzBlur: [{ type: i0.Output, args: ["nzBlur"] }], nzFocus: [{ type: i0.Output, args: ["nzFocus"] }], nzOnStep: [{ type: i0.Output, args: ["nzOnStep"] }], inputRef: [{ type: i0.ViewChild, args: ['input', { isSignal: true }] }], hostRef: [{ type: i0.ViewChild, args: ['inputNumberHost', { isSignal: true }] }], prefix: [{ type: i0.ContentChild, args: [i0.forwardRef(() => NzInputPrefixDirective), { isSignal: true }] }], suffix: [{ type: i0.ContentChild, args: [i0.forwardRef(() => NzInputSuffixDirective), { isSignal: true }] }], addonBefore: [{ type: i0.ContentChild, args: [i0.forwardRef(() => NzInputAddonBeforeDirective), { isSignal: true }] }], addonAfter: [{ type: i0.ContentChild, args: [i0.forwardRef(() => NzInputAddonAfterDirective), { isSignal: true }] }] } });
/**
...
class NzInputNumberModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzInputNumberModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.0", ngImport: i0, type: NzInputNumberModule, imports: [NzInputNumberComponent,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzInputNumberModule, imports: [NzInputNumberComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.0", ngImport: i0, type: NzInputNumberModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
