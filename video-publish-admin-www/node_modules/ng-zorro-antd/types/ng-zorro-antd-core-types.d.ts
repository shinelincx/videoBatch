...
export { tuple };
export type { BooleanInput, CompareWith, FunctionProp, IndexableObject, InputObservable, NgClassInterface, NgClassType, NgStyleInterface, NumberInput, NzDirectionVHType, NzFourDirectionType, NzPlacement, NzSafeAny, NzShapeSCType, NzSizeDSType, NzSizeLDSType, NzSizeLMSType, NzSizeMDSType, NzStatus, NzTSType, NzValidateStatus, NzVariant, OnChangeType, OnTouchedType };
