...
import { NzShapeSCType, NzSizeLDSType, NzSizeDSType, NzVariant, NzSafeAny, NzSizeMDSType, NzTSType } from 'ng-zorro-antd/core/types';
...
export type { AffixConfig, AlertConfig, AnchorConfig, AvatarConfig, BadgeConfig, ButtonConfig, CardConfig, CarouselConfig, CascaderConfig, CodeEditorConfig, CollapseConfig, CollapsePanelConfig, DatePickerConfig, DescriptionsConfig, DrawerConfig, DropdownConfig, EmptyConfig, FilterTriggerConfig, FloatButtonConfig, FormConfig, IconConfig, ImageConfig, ImageExperimentalConfig, MessageConfig, ModalConfig, NotificationConfig, NzConfig, NzConfigKey, PageHeaderConfig, PaginationConfig, PopConfirmConfig, PopoverConfig, PrefixCls, ProgressConfig, RateConfig, SegmentedConfig, SelectConfig, SpaceConfig, SpinConfig, SwitchConfig, TableConfig, TabsConfig, Theme, TimePickerConfig, TreeConfig, TreeSelectConfig, TypographyConfig };
