...
declare abstract class NzTooltipBaseComponent {
...
declare class NzTooltipComponent extends NzTooltipBaseComponent {
    protected _animationPrefix: string;
    nzTitle: NzTSType | null;
    ...
    protected readonly zoomAnimationEnter: i0.Signal<string>;
    protected readonly zoomAnimationLeave: i0.Signal<string>;
