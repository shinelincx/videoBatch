...
import { TemplateRef, OnInit, OnChanges, EventEmitter, SimpleChanges } from '@angular/core';
...
declare class NzColorBlockComponent {
    nzColor: string;
    nzSize: NzSizeLDSType;
    readonly nzOnClick: EventEmitter<void>;
...
export type { NzColor, NzColorPickerFormatType, NzColorPickerTriggerType, NzPresetColor, ValidForm, ValidFormKey };
