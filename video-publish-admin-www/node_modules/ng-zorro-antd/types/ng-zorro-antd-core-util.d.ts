...
import { NzSafeAny, IndexableObject, FunctionProp, NgStyleInterface, NzValidateStatus, NgClassInterface, NzVariant } from 'ng-zorro-antd/core/types';
...
declare function toCssPixelNumber(value: number | string): number;
/**
...
declare function getClassListFromValue(value: string | string[]): string[] | null;
...
declare function triggerFocus(element: HTMLInputElement | HTMLTextAreaElement, option?: InputFocusOptions): void;

export { InputBoolean, InputCssPixel, InputNumber, arraysEqual, canUseDom, createDebugEle, encodeEntities, ensureInBounds, ensureNumberInRange, fromEventOutsideAngular, generateClassName, getCaretCoordinates, getClassListFromValue, getElementOffset, getEventPosition, getMentions, getPercent, getPrecision, getRegExp, getRepeatedElement, getStatusClassNames, getStyleAsText, getVariantClassNames, inNextTick, injectCSS, isNil, isNonEmptyString, isNotNil, isNumberFinite, isPromise, isStyleSupport, isTemplateRef, isTouchEvent, measure, measureScrollbar, numberAttributeWithInfinityFallback, numberAttributeWithOneFallback, numberAttributeWithZeroFallback, padEnd, padStart, properties, pxToNumber, removeCSS, scrollIntoView, shallowCopyArray, shallowEqual, silentEvent, sum, toArray, toBoolean, toCssPixel, toCssPixelNumber, toDecimal, toNumber, triggerFocus, updateCSS, valueFunctionProp, wrapIntoObservable };
export type { Coordinates, InputFocusOptions, MeasureResult, MouseTouchObserverConfig };
