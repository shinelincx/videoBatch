...
import { OnChanges, OnInit, TemplateRef, EventEmitter, AnimationCallbackEvent, SimpleChanges } from '@angular/core';
import { Direction } from '@angular/cdk/bidi';
import { NzConfigKey } from 'ng-zorro-antd/core/config';

declare class NzAlertMarqueeComponent {
    private readonly destroyRef;
    readonly nzPauseOnHover: i0.InputSignalWithTransform<boolean, unknown>;
    readonly nzSpeed: i0.InputSignalWithTransform<number, unknown>;
    private readonly track1Ref;
    private readonly track2Ref;
    private readonly trackWidth;
    protected readonly animationDuration: i0.Signal<number>;
    protected readonly class: i0.Signal<{
        'ant-alert-marquee': boolean;
        'ant-alert-marquee-pause-on-hover': boolean;
    }>;
    constructor();
    static ɵfac: i0.ɵɵFactoryDeclaration<NzAlertMarqueeComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NzAlertMarqueeComponent, "nz-alert-marquee", never, { "nzPauseOnHover": { "alias": "nzPauseOnHover"; "required": false; "isSignal": true; }; "nzSpeed": { "alias": "nzSpeed"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
...
declare class NzAlertModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<NzAlertModule, never, [typeof NzAlertComponent, typeof NzAlertMarqueeComponent], [typeof NzAlertComponent, typeof NzAlertMarqueeComponent]>;
