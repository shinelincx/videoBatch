import { LayoutConfig, HierarchyBaseNodeInfo, HierarchyGraphNodeInfo, HierarchyBaseEdgeInfo, HierarchyGraphDef, HierarchyGraphNodeDef, HierarchyGraphEdgeDef, HierarchyGraphOption } from 'dagre-compound';
import { NzSafeAny } from 'ng-zorro-antd/core/types';
import { SelectionModel } from '@angular/cdk/collections';
import { Observable, ReplaySubject } from 'rxjs';
import * as i0 from '@angular/core';
import { EventEmitter, OnInit, TemplateRef, OnChanges, AfterContentChecked, QueryList, ElementRef, SimpleChanges, NgZone } from '@angular/core';
...
declare class NzGraphNodeComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzGraphNodeComponent, "[nz-graph-node]", never, { "node": { "alias": "node"; "required": false; }; "customTemplate": { "alias": "customTemplate"; "required": false; }; }, {}, never, never, true, never>;
}
...
declare class NzGraphComponent implements OnInit, OnChanges, AfterContentChecked, NzGraph {
    ...
    protected readonly typedNodes: (item: unknown) => (NzGraphGroupNode | NzGraphNode)[];
    protected readonly asNzGraphEdges: (data: unknown) => NzGraphEdge[];
    protected readonly edgeTrackByFun: (edge: NzGraphEdge) => string;
...
declare class NzGraphZoomDirective {
    private destroyRef;
    private cdr;
    private element;
    nzZoom?: number;
