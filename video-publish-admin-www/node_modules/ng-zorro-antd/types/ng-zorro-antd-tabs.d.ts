...
import { TemplateRef, ElementRef, InjectionToken, OnChanges, OnDestroy, EventEmitter, SimpleChanges, AfterViewInit, AfterContentChecked, QueryList, OnInit, AfterContentInit } from '@angular/core';
...
type NzIndicatorAlign = 'start' | 'end' | 'center';
interface NzIndicator {
...
declare class NzTabBarExtraContentDirective {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTabBarExtraContentDirective, "[nzTabBarExtraContent]:not(nz-tabs)", never, { "position": { "alias": "nzTabBarExtraContent"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}

type AnimationState = 'enter-start' | 'enter-active' | 'leave-start' | 'leave-active' | 'void' | 'hidden';
declare class NzTabBodyComponent {
    private readonly elementRef;
    readonly content: i0.InputSignal<TemplateRef<void> | null>;
    readonly active: i0.InputSignal<boolean>;
    readonly animated: i0.InputSignal<boolean>;
    protected readonly _animationState: i0.WritableSignal<AnimationState>;
    protected readonly _animationEnabled: i0.Signal<boolean>;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NzTabBodyComponent, "[nz-tab-body]", ["nzTabBody"], { "content": { "alias": "content"; "required": false; "isSignal": true; }; "active": { "alias": "active"; "required": false; "isSignal": true; }; "animated": { "alias": "animated"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
...
declare class NzTabsInkBarDirective {
    ...
    readonly position: i0.InputSignal<NzTabPositionMode>;
    readonly animated: i0.InputSignal<boolean>;
    readonly indicator: i0.InputSignal<NzIndicator | undefined>;
    protected readonly animationEnabled: i0.Signal<boolean>;
    alignToElement(element: HTMLElement): void;
    private setStyles;
    private setIndicatorPosition;
    static ɵfac: i0.ɵɵFactoryDeclaration<NzTabsInkBarDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<NzTabsInkBarDirective, "nz-tabs-ink-bar, [nz-tabs-ink-bar]", never, { "position": { "alias": "position"; "required": false; "isSignal": true; }; "animated": { "alias": "animated"; "required": false; "isSignal": true; }; "indicator": { "alias": "indicator"; "required": false; "isSignal": true; }; }, {}, never, never, true, never>;
}
...
declare class NzTabsComponent implements OnInit, AfterContentChecked, AfterContentInit {
    ...
    readonly nzIndicator: i0.InputSignal<NzIndicator | undefined>;
...
export type { NzAnimatedInterface, NzIndicator, NzIndicatorAlign, NzTabPosition, NzTabPositionMode, NzTabScrollEvent, NzTabScrollEventHandlerFun, NzTabScrollListOffset, NzTabScrollListOffsetEvent, NzTabType, NzTabsCanDeactivateFn, TabTemplateContext };
