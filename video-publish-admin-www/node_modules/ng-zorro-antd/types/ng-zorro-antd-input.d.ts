...
import { AfterViewInit, DoCheck, TemplateRef, OnInit, ComponentRef, AfterContentInit, OnChanges, QueryList, SimpleChanges, ElementRef, InjectionToken } from '@angular/core';
...
import { InputFocusOptions } from 'ng-zorro-antd/core/util';
...
declare class NzInputDirective implements OnInit {
    ...
    readonly nzVariant: _angular_core.InputSignal<NzVariant | undefined>;
    ...
    protected readonly finalSize: _angular_core.Signal<NzSizeLDSType | undefined>;
...
interface NzCountConfig {
    max?: number;
    strategy?: (value: string) => number;
    exceedFormatter?: (value: string, config: {
        max: number;
    }) => string;
}
declare class NzInputWrapperComponent {
    ...
    readonly nzShowCount: _angular_core.InputSignalWithTransform<boolean, unknown>;
    readonly nzCount: _angular_core.InputSignal<NzCountConfig | undefined>;
    readonly nzClear: _angular_core.OutputEmitterRef<void>;
    readonly size: _angular_core.Signal<ng_zorro_antd_core_types.NzSizeLDSType>;
    readonly variant: _angular_core.Signal<ng_zorro_antd_core_types.NzVariant | undefined>;
    ...
    protected readonly inputValue: _angular_core.Signal<any>;
    protected readonly formattedValue: _angular_core.Signal<string>;
    protected readonly computedCount: _angular_core.Signal<number>;
    protected readonly dataCount: _angular_core.Signal<string>;
    protected readonly isOutOfRange: _angular_core.Signal<boolean>;
    constructor();
    clear(): void;
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<NzInputWrapperComponent, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<NzInputWrapperComponent, "nz-input-wrapper,nz-input-password,nz-input-search", ["nzInputWrapper"], { "nzAllowClear": { "alias": "nzAllowClear"; "required": false; "isSignal": true; }; "nzPrefix": { "alias": "nzPrefix"; "required": false; "isSignal": true; }; "nzSuffix": { "alias": "nzSuffix"; "required": false; "isSignal": true; }; "nzAddonBefore": { "alias": "nzAddonBefore"; "required": false; "isSignal": true; }; "nzAddonAfter": { "alias": "nzAddonAfter"; "required": false; "isSignal": true; }; "nzShowCount": { "alias": "nzShowCount"; "required": false; "isSignal": true; }; "nzCount": { "alias": "nzCount"; "required": false; "isSignal": true; }; }, { "nzClear": "nzClear"; }, ["inputRef", "inputDir", "prefix", "suffix", "addonBefore", "addonAfter", "inputPasswordIconTmpl", "inputSearchEnterButton"], ["[nzInputAddonBefore]", "[nzInputSearchEnterButton]", "[nzInputAddonAfter]", "[nzInputPrefix]", "[nzInputClearIcon]", "[nzInputSuffix]", "[nz-input]"], true, [{ directive: typeof i1.NzSpaceCompactItemDirective; inputs: {}; outputs: {}; }]>;
}
...
export type { AutoSizeType, NzCountConfig, NzInputSearchEvent };
