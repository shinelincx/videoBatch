...
import { NgClassInterface, NzValidateStatus, NzSizeLDSType, NzStatus, NzVariant, NzSafeAny, NzPlacement } from 'ng-zorro-antd/core/types';
...
declare class NzTimePickerComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnChanges {
    ...
    private readonly formSize;
    private readonly formVariant;
    private hasConfirmed;
    readonly nzPrefix: _angular_core.InputSignal<string | TemplateRef<void> | undefined>;
    readonly nzNeedConfirm: _angular_core.InputSignalWithTransform<boolean, unknown>;
    readonly nzPlacement: _angular_core.InputSignal<NzPlacement>;
    protected readonly currentPosition: _angular_core.WritableSignal<_angular_cdk_overlay.ConnectionPositionPair>;
    protected readonly overlayPositions: _angular_core.Signal<_angular_cdk_overlay.ConnectionPositionPair[]>;
    protected readonly timepickerAnimationEnter: _angular_core.Signal<string>;
    protected readonly timepickerAnimationLeave: _angular_core.Signal<string>;
    ...
    protected finalSize: _angular_core.Signal<NzSizeLDSType | undefined>;
    protected readonly finalVariant: _angular_core.Signal<NzVariant>;
    protected dropdownTimePickerClass: _angular_core.Signal<string[]>;
    private size;
    ...
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<NzTimePickerComponent, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<NzTimePickerComponent, "nz-time-picker", ["nzTimePicker"], { "nzId": { "alias": "nzId"; "required": false; }; "nzSize": { "alias": "nzSize"; "required": false; }; "nzStatus": { "alias": "nzStatus"; "required": false; }; "nzVariant": { "alias": "nzVariant"; "required": false; }; "nzHourStep": { "alias": "nzHourStep"; "required": false; }; "nzMinuteStep": { "alias": "nzMinuteStep"; "required": false; }; "nzSecondStep": { "alias": "nzSecondStep"; "required": false; }; "nzClearText": { "alias": "nzClearText"; "required": false; }; "nzNowText": { "alias": "nzNowText"; "required": false; }; "nzOkText": { "alias": "nzOkText"; "required": false; }; "nzPopupClassName": { "alias": "nzPopupClassName"; "required": false; }; "nzPlaceHolder": { "alias": "nzPlaceHolder"; "required": false; }; "nzAddOn": { "alias": "nzAddOn"; "required": false; }; "nzDefaultOpenValue": { "alias": "nzDefaultOpenValue"; "required": false; }; "nzDisabledHours": { "alias": "nzDisabledHours"; "required": false; }; "nzDisabledMinutes": { "alias": "nzDisabledMinutes"; "required": false; }; "nzDisabledSeconds": { "alias": "nzDisabledSeconds"; "required": false; }; "nzFormat": { "alias": "nzFormat"; "required": false; }; "nzOpen": { "alias": "nzOpen"; "required": false; }; "nzUse12Hours": { "alias": "nzUse12Hours"; "required": false; }; "nzSuffixIcon": { "alias": "nzSuffixIcon"; "required": false; }; "nzHideDisabledOptions": { "alias": "nzHideDisabledOptions"; "required": false; }; "nzAllowEmpty": { "alias": "nzAllowEmpty"; "required": false; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; }; "nzAutoFocus": { "alias": "nzAutoFocus"; "required": false; }; "nzBackdrop": { "alias": "nzBackdrop"; "required": false; }; "nzInputReadOnly": { "alias": "nzInputReadOnly"; "required": false; }; "nzPrefix": { "alias": "nzPrefix"; "required": false; "isSignal": true; }; "nzNeedConfirm": { "alias": "nzNeedConfirm"; "required": false; "isSignal": true; }; "nzPlacement": { "alias": "nzPlacement"; "required": false; "isSignal": true; }; }, { "nzOpenChange": "nzOpenChange"; }, never, never, true, [{ directive: typeof i1.NzSpaceCompactItemDirective; inputs: {}; outputs: {}; }]>;
...
declare class NzTimePickerModule {
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<NzTimePickerModule, never>;
    static ɵmod: _angular_core.ɵɵNgModuleDeclaration<NzTimePickerModule, never, [typeof NzTimePickerComponent, typeof NzTimePickerPanelComponent], [typeof NzTimePickerPanelComponent, typeof NzTimePickerComponent]>;
    static ɵinj: _angular_core.ɵɵInjectorDeclaration<NzTimePickerModule>;
}
