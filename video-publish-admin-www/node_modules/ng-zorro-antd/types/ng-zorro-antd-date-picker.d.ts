...
import { TemplateRef, OnChanges, EventEmitter, SimpleChanges, OnDestroy, OnInit, ChangeDetectorRef, AfterViewInit, ElementRef, QueryList } from '@angular/core';
import { CandyDate, CompatibleValue, NormalizedMode, SingleValue } from 'ng-zorro-antd/core/time';
import { NzSafeAny, FunctionProp, BooleanInput, NgClassInterface, NzValidateStatus, NzStatus, NzVariant, NzPlacement, NzSizeLDSType, OnChangeType, OnTouchedType } from 'ng-zorro-antd/core/types';
...
declare class NzDatePickerComponent implements OnInit, OnChanges, AfterViewInit, ControlValueAccessor {
    ...
    readonly nzInline: i0.InputSignalWithTransform<boolean, unknown>;
    ...
    nzPopupStyle: object;
    readonly nzDropdownClassName: i0.InputSignal<string | undefined>;
    ...
    protected readonly datepickerAnimationEnter: i0.Signal<string>;
    protected readonly datepickerAnimationLeave: i0.Signal<string>;
    protected readonly dropdownClass: i0.Signal<string[]>;
    get realOpenState(): boolean;
    protected finalSize: i0.Signal<NzSizeLDSType | undefined>;
    ...
    ngOnInit(): void;
    ngOnChanges({ nzStatus, nzPlacement, nzPopupStyle, nzPlaceHolder, nzLocale, nzFormat, nzRenderExtraFooter, nzMode, nzSize, nzVariant }: SimpleChanges): void;
...
declare class InnerPopupComponent implements OnChanges {
    ...
    readonly cellHover: EventEmitter<CandyDate | null>;
    prefixCls: string;
    /**
...
export type { CompatibleDate, DisabledDateFn, DisabledTimeConfig, DisabledTimeFn, DisabledTimePartial, NzDateMode, NzDatePickerSizeType, NzPanelChangeType, PresetRanges, RangePartType, SupportTimeOptions };
