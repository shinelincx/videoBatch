...
type NzInputNumberStepEmitter = 'wheel' | 'handler' | 'keyboard';
interface NzInputNumberStepEvent {
    value: number;
    offset: number;
    type: 'up' | 'down';
...
declare class NzInputNumberComponent implements OnInit, ControlValueAccessor {
    ...
    readonly nzChangeOnWheel: _angular_core.InputSignalWithTransform<boolean, unknown>;
    ...
    readonly nzOnStep: _angular_core.OutputEmitterRef<NzInputNumberStepEvent>;
    private onChange;
    private onTouched;
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<NzInputNumberComponent, "nz-input-number", ["nzInputNumber"], { "nzId": { "alias": "nzId"; "required": false; "isSignal": true; }; "nzSize": { "alias": "nzSize"; "required": false; "isSignal": true; }; "nzPlaceHolder": { "alias": "nzPlaceHolder"; "required": false; "isSignal": true; }; "nzStatus": { "alias": "nzStatus"; "required": false; "isSignal": true; }; "nzVariant": { "alias": "nzVariant"; "required": false; "isSignal": true; }; "nzStep": { "alias": "nzStep"; "required": false; "isSignal": true; }; "nzMin": { "alias": "nzMin"; "required": false; "isSignal": true; }; "nzMax": { "alias": "nzMax"; "required": false; "isSignal": true; }; "nzPrecision": { "alias": "nzPrecision"; "required": false; "isSignal": true; }; "nzParser": { "alias": "nzParser"; "required": false; "isSignal": true; }; "nzFormatter": { "alias": "nzFormatter"; "required": false; "isSignal": true; }; "nzDisabled": { "alias": "nzDisabled"; "required": false; "isSignal": true; }; "nzReadOnly": { "alias": "nzReadOnly"; "required": false; "isSignal": true; }; "nzAutoFocus": { "alias": "nzAutoFocus"; "required": false; "isSignal": true; }; "nzKeyboard": { "alias": "nzKeyboard"; "required": false; "isSignal": true; }; "nzControls": { "alias": "nzControls"; "required": false; "isSignal": true; }; "nzChangeOnWheel": { "alias": "nzChangeOnWheel"; "required": false; "isSignal": true; }; "nzPrefix": { "alias": "nzPrefix"; "required": false; "isSignal": true; }; "nzSuffix": { "alias": "nzSuffix"; "required": false; "isSignal": true; }; "nzAddonBefore": { "alias": "nzAddonBefore"; "required": false; "isSignal": true; }; "nzAddonAfter": { "alias": "nzAddonAfter"; "required": false; "isSignal": true; }; }, { "nzBlur": "nzBlur"; "nzFocus": "nzFocus"; "nzOnStep": "nzOnStep"; }, ["prefix", "suffix", "addonBefore", "addonAfter"], ["[nzInputAddonBefore]", "[nzInputAddonAfter]", "[nzInputPrefix]", "[nzInputSuffix]", "[nzInputNumberUpIcon]", "[nzInputNumberDownIcon]"], true, [{ directive: typeof i1.NzSpaceCompactItemDirective; inputs: {}; outputs: {}; }]>;
}
...
export type { NzInputNumberStepEmitter, NzInputNumberStepEvent };
