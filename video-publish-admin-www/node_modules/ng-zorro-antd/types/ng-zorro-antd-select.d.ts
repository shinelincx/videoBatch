...
declare class NzSelectComponent implements ControlValueAccessor, OnInit, AfterContentInit, OnChanges {
    ...
    protected readonly selectAnimationEnter: i0.Signal<string>;
    protected readonly selectAnimationLeave: i0.Signal<string>;
    prefixCls: string;
