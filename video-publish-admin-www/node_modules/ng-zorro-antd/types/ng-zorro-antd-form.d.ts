...
import { InputObservable, NzSizeLDSType, NzVariant, NzTSType } from 'ng-zorro-antd/core/types';
...
declare class NzFormDirective implements OnChanges, InputObservable {
    ...
    nzLabelWrap: boolean;
    readonly nzSize: i0.InputSignal<NzSizeLDSType | undefined>;
    readonly nzVariant: i0.InputSignal<NzVariant>;
