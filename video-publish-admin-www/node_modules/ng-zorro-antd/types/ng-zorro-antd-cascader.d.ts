...
declare class NzCascaderComponent extends NzTreeBase implements NzCascaderComponentAsSource, OnInit, OnChanges, ControlValueAccessor {
    ...
    protected readonly cascaderAnimationEnter: i0.Signal<string>;
    protected readonly cascaderAnimationLeave: i0.Signal<string>;
    ...
    nzPrefix: string | TemplateRef<void> | null;
    ...
    protected readonly finalSize: i0.Signal<NzSizeLDSType | undefined>;
